...
import com.example.course_project.userInfo.*;
...
//		CommentSearchProduct p = new CommentSearchProduct();
//		p.setData("my comment");
//		p.setPk("2");
//		p.setUserid("2");
//		commentSearchRepository.save(p);


		//System.out.println(searchRepository.findAll());

//		System.out.println(collectionSearchRepository.findByNameContaining("Text to be saved"));
//		System.out.println(commentSearchRepository.findByDataContaining("Text to be saved"));
